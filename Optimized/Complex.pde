class Complex {
  ...
  public ComplexNum exp(ComplexNum z) {
    return this.polar(Math.exp(z.a), z.b);
  }
  
  public ComplexNum exp(double k,ComplexNum z) {
    return this.polar(Math.exp(z.a*Math.log(k)),Math.log(k)*z.b);
  }
  
  //public ComplexNum exp(ComplexNum z1, ComplexNum z2) {
  //  return this.polar();
  //}
}
